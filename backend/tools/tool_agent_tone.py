    ...
    try:
        response = client.messages.create(
            ...
            system=(
                ...
                "tension_handling (int 1-10): how well the agent managed the emotional state of the call; "
                "1=made tension worse or ignored patient distress, 5=acknowledged but did not improve the mood, 10=clearly calmed the patient and kept the call constructive. "
